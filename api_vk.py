...
class VK:
    ...
    def get_user_info(self, user_ids, fields):
        ...
        data['photo_att'] = f'photo-{data["response"][0]["photo_id"]}'
        return data
    ...
    def next(self, search_result_list):
        ...
        while search_result_list_cursor < len(search_result_list):
            ...
            if search_result_list_cursor >= len(search_result_list):
                break
            yield search_result_list[search_result_list_cursor]
...
if __name__ == '__main__':
    ...
    user = vk.get_user_info(371521,'bdate,city,sex,photo_id')
